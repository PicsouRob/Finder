...
import { SocialWrapper, Input, InputContent, ButtonSearch, Select } from './HomeStyle';
                        ...
                        <main class="mt-16 pb-4 mx-auto max-w-7xl px-6 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                            <div class="sm:text-center lg:text-left">
                                <h1 class="text-4xl tracking-tight font-extrabold text-indigo-900 sm:text-5xl md:text-6xl">
                                    <span class="block xl:inline text-gray-900 leading-[25px]">Trouver des Embaucheurs en ligne pour votre travail</span>
                                </h1>
                                ...
                                <InputContent>
                                    <Input width={width} value={jobValue} placeholder="Le titre ici" onChange={(e) => setJobValue(e.target.value)} />
                                    <RiMapPin2Line size={15} />
                                    <Select id="select-ville" onChange={(e) => setCityValue(e.target.value)}>
                                        <option value="Ville" selected>Ville</option>
                                        {city.map((items, index) => (
                                            <option key={index} value={items}>{items}</option>
                                        ))}
                                    </Select>
                                    <ButtonSearch onClick={() => history.push({
                                ...
                                <div class="mt-4 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                                    ...
                                    >
                                        <span class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-red-400 hover:bg-red-500 md:py-4 md:text-lg md:px-10 cursor-pointer">
                                            Commencer
                                        </span>
                                    </div>
                                </div>
